...
(0, test_1.test)('Iframe testing', async ({ page }) => {
    test_1.test.slow();
    await page.goto('https://tvn24.pl/');
    await (0, elementgetnclick_1.click)(page, 'Accepted cookies', '#onetrust-accept-btn-handler');
    ...
    await (0, elementgetnclick_1.click)(page, 'Clicked biznes button', 'a[href="/biznes"]');
    await page.evaluate(() => {
        window.scrollBy(0.5, window.innerHeight);
    });
    await (0, elementgetnclick_1.click)(page, 'Clicked show more', 'div[class="sc-c59qa8-0 TextBoxWrapper-sc-1okctb2-0 ejktja dYxSXU stock-quotes-current-rates-2iajrp TextBox"]');
    await page.waitForTimeout(5000);
    await page.goBack();
    await (0, elementgetnclick_1.click)(page, 'Clicked news of the day item', '//div[@class="news-of-the-day__item-content" and text()="Podwyżki i promocje. Co czeka kierowców"]');
    await page.goBack();
